...

{
...

	{
		...
		monta = "document.form." + campo + ".focus();";
...

{
	...
	var Agencia = parseInt(document.form.my_ag.value);

	var Conta = parseInt(document.form.my_ct.value);

	var Digito = parseInt(document.form.my_dg.value);
...

{
	...
	var dv_informado = document.form.my_dg.value;

	var dv_conta = document.form.my_ct.value;

	var tam = document.form.my_ct.value.length;
...

{
...

	{
		...
		case "agencia" : {
			...
			if(document.form.my_ag.value.length == 4)
		...
		case "conta" : {
			...
			if(document.form.my_ct.value.length == 7)
